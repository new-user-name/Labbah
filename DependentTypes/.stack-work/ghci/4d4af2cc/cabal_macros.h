...
/* package DependentTypes-0.1.0.0 */
#ifndef VERSION_DependentTypes
#define VERSION_DependentTypes "0.1.0.0"
#endif /* VERSION_DependentTypes */
#ifndef MIN_VERSION_DependentTypes
#define MIN_VERSION_DependentTypes(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_DependentTypes */
...
#define CURRENT_COMPONENT_ID "DependentTypes-0.1.0.0-7zXdAGxecAOE7WXIDLaV45-DependentTypes"
